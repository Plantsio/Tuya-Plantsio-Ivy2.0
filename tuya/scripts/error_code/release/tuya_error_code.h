...
#define OPRT_SVC_LAN_EXT_ALREADY_RPT                       (-0x1503)  //-5379, 扩展协议数据已经被上报
#define OPRT_SVC_LAN_ERRCODE_MAX_CNT 4
...
#define OPRT_SVC_UPGRADE_FILE_IS_FULL                      (-0x1904)  //-6404, 接收文件已满
#define OPRT_SVC_UPGRADE_ERRCODE_MAX_CNT 5
...
#define OPRT_LINK_CORE_HTTP_RESPONSE_BUFFER_EMPTY          (-0x1e0a)  //-7690, HTTP buffer为空
...
#define OPRT_GW_BASE_LINKAGE_RULE_IS_UPDATED               (-0x3304)  //-13060, 联动规则在更新中,请稍后重试
...
#define OPRT_OS_ADAPTER_WF_LPMODE_SET_FAILED               (-0x691c)  //-26908, Wi-Fi低功耗设置失败
